                  ...
                  <div className="lg:col-span-2">
                    ...
                    <div className="space-y-10">
                      ...
                      <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {(t(`consultancy.services.${selectedService}.details.requirements`, { returnObjects: true }) as string[]).map((req, reqIdx) => (
                          <li key={`req-${reqIdx}-${req}`} className="flex items-start gap-4 text-gray-600 text-sm bg-paper p-6 rounded-2xl border border-gray-100 premium-shadow">
